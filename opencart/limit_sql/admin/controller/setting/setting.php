...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_alt_seviye_adet'])) {
			$data['config_alt_seviye_adet'] = $this->request->post['config_alt_seviye_adet'];
		} else {
			$data['config_alt_seviye_adet'] = $this->config->get('config_alt_seviye_adet');
		}
